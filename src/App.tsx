...
const AppContent: React.FC = () => {
  ...
  const handleSepoliaClick = () => {
  window.location.href = "https://pay-paglu-sepolia-net.vercel.app/";
};
      ...
      <div className="w-full md:w-3/5 bg-transparent backdrop-blur-sm p-8">
        ...
        <div className="space-y-4 animate-[fadeIn_0.6s_ease-out_400ms]">
          {[
            ...
            { color: 'bg-red-500', text: 'Low transaction fees with Morph network' },
  ...
  Want to use on Sepolia network?{' '}
  <button
